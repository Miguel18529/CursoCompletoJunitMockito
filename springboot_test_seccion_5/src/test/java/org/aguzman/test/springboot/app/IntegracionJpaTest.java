...
public class IntegracionJpaTest {
    ...
    void testFindById() {
        ...
        System.out.println(cuenta.orElseThrow(NoSuchElementException::new));
        assertTrue(cuenta.isPresent());
        assertEquals("Andrés", cuenta.orElseThrow(NoSuchElementException::new).getPersona());
    }
    ...
    void testFindByPersona() {
        ...
        assertTrue(cuenta.isPresent());
        assertEquals("Andrés", cuenta.orElseThrow(NoSuchElementException::new).getPersona());
        assertEquals("1000.00", cuenta.orElseThrow(NoSuchElementException::new).getSaldo().toPlainString());
    }
