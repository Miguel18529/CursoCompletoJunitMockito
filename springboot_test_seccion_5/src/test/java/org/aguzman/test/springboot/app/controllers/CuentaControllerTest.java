...
class CuentaControllerTest {
    ...
    void testdetalle() throws Exception {
        // Given
        when(cuentaService.findById(1L)).thenReturn(crearCuenta001().orElseThrow(NoSuchElementException::new));
    ...
    void testListar() throws Exception {
        // Given
        List<Cuenta> cuentas = Arrays.asList(crearCuenta001().orElseThrow(NoSuchElementException::new),
                crearCuenta002().orElseThrow(NoSuchElementException::new));
